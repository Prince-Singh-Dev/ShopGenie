...
function OurPolicy() {
  return (
    <div className='w-[100vw] h-[100vh] md:h-[70vh] flex items-center justify-start flex-col bg-gradient-to-b from-[#141414] to-[#0c2025] gap-[50px]'>
        <div className='h-[80%] w-[100%] text-center mt-[70px]'>
        ...
        <div className='w-[100%] md:min-h-[50%] h-[20%] flex items-center justify-center flex-wrap lg:gap-[50px] gap-[80px]'>
            ...
            <div className='w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]'>
                ...
                <p className='font-semibold md:text-[18px] text-[12px] text-[aliceblue] text-center'>Shop With Confidence - 7 Days Easy Return Policy.</p>
            </div>
            ...
            <div className='w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]'>
                ...
                <p className='font-semibold md:text-[18px] text-[12px] text-[aliceblue] text-center'>Trusted Company - 24/7 Support - Customer Satisfaction Is Our Priority.</p>
            </div>
        </div>
    </div>
  )
