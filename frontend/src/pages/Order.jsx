...
function Order() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] p-[20px] pb-[150px] overflow-hidden bg-gradient-to-b from-[#141414] to-[#0c2025]'>
          ...
          orderData.map((item,index) => (
            <div key={index} className='w-[100%] h-[10%] border-t border-b'>
              <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                <img src={item.image1} alt="" className='w-[120px] h-[130px] rounded-md'/>
                ...
                <div className='flex items-start justify-center flex-col gap-[5px]'>
                  ...
                  <div className='flex items-center'>
                    <p className='md:text-[16px] text-[12px] text-[#aaf4e7]'>Payement Method : {item.paymentMethod}</p>
                  </div>
                  ...
                  <div className='absolute md:right-[5%] right-[1%] md:top-[40%] top-[70%]'>
                    <button className='md:px-[15px] px-[5px] py-[3px] rounded-mg bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500' onClick={loadOrderData}>Track Order</button>
                  </div>
