...
function PlaceOrder() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-b from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px] relative'>
      ...
      <div className='lg:w-[50%] w-[100%] min-h-[100%] flex items-center justify-center gap-[30px]'>
        <div className='lg:w-[70%] w-[90%] lg:h-[70%] h-[100%] flex items-center justify-center gap-[10px] flex-col'>
          ...
          <div className='w-[100%] h-[30vh] lg:h-[100px] flex items-start mt-[20px] lg:mt-[0px] justify-center gap-[50px]'>
            ...
            <button onClick={()=>setMethod('razorpay')} className={`w-[150px] h-[50px] rounded-sm ${method === 'razorpay' ? 'border-[5px] border-blue-900' : ''}`}><img src={razorpay} className='w-[100%] h-[100%] object-fill rounded-sm' alt=''/></button>
            
            <button onClick={()=>setMethod('cod')} className={`w-[200px] h-[50px] bg-gradient-to-r from-[#95b3f8] to-[#white] text-[14px] px-[20px] rounded-sm text-[black] font-bold ${method === 'cod' ? 'border-[5px] border-blue-900 rounded-sm' : ''} : ''}`}>CASH ON DELIVERY</button>
