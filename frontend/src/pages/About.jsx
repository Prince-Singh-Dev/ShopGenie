...
function About() {
  return (
    <div className='w-[80vw] md:w-[100vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-b from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
        <Title text1={'ABOUT'} text2={'US'}/>
        <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
          <div className='lg:w-[50%] w-[100%] flex items-center justify-center'>
            <img src={aboutus} alt="" className='lg:w-[65%] w-[80%] shadow-md shadow-black rounded-sm'/>
          </div>
          <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>

            <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
              ShopGenie born for smart , seamless shopping-created to deliver quality products, trending styles and everyday essentials in one place. With reliable service, Fast Delivery and Great Values. ShopGenie makes your online shopping experience simple, satisfying and stress-free.
            </p>
            ...
            <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
              Our mission is  to redefine online shopping by delivering quality, affordability and convenience. ShopGenie connects customers with trusted products and brands, offering a seamless, customer-focused experience that saves time, adds value and fits every lifestyle and need.
            </p>
        ...
        <div className='w-[100%] flex items-center justify-center flex-col gap-[10px]'>
            ...
            <div className='w-[80%] flex items-center justify-center lg:flex-row flex-col py-[40px]'>
              ...
              <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
                ...
                <p>We guarantee quality through strict checks, reliable sourcing and a commitement to customer satisfaction always.</p>
              </div>
